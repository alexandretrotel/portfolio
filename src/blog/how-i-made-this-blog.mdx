...
Hi and welcome to my blog! I wanted to share with you how I built it with **[Next.js](https://nextjs.org/)**. It&apos;s not too hard, and I'll explain it in a simple way. You can find the code on **[GitHub](https://github.com/atrtde/atrtde)**. Let's go through it step by step.
