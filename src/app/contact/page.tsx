...
const socials = [
  {
    title: "LinkedIn",
    description: "I share a lot of content there",
    href: "https://www.linkedin.com/in/trotelalexandre",
    button: "View my fake life",
  ...
  },
  {
    ...
    button: "Listen to my weird music",
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col max-w-sm">
        <h1 className="text-2xl font-semibold">Alexandre Trotel</h1>
