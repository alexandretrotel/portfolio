import type { Category, YearGroup } from "@/types/goals";

export const goalCategoryLabels: Record<Category, string> = {
  personal: "Personal",
  startup: "Startup",
...
export const goalCategoryOrder: Category[] = [
  "personal",
  "startup",
  "open_source",
  "social",
...
export const goalRoadmap: YearGroup[] = [
  {
    year: "future",
    items: [
      {
